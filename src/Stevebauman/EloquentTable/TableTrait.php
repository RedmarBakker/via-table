...
trait TableTrait
{
    ...
    */
    ...
    public function render($view = '')
    {
        ...
        if (is_array($this->eloquentTableAttributes) && count($this->eloquentTableAttributes) === 0
        || is_string($this->eloquentTableAttributes) && strlen($this->eloquentTableAttributes) === 0) {
